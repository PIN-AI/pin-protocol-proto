...
func (ValidationPolicy_Mode) EnumDescriptor() ([]byte, []int) {
	return file_validation_proto_rawDescGZIP(), []int{0, 0}
}
...
func (VerificationRecord_Verdict) Descriptor() protoreflect.EnumDescriptor {
	return file_validation_proto_enumTypes[1].Descriptor()
}

func (VerificationRecord_Verdict) Type() protoreflect.EnumType {
	return &file_validation_proto_enumTypes[1]
}
...
func (VerificationRecord_Verdict) EnumDescriptor() ([]byte, []int) {
	return file_validation_proto_rawDescGZIP(), []int{1, 0}
}
...
func (*ValidationPolicy_ExecutionLimits) Descriptor() ([]byte, []int) {
	return file_validation_proto_rawDescGZIP(), []int{0, 1}
}
...
func (*ValidationPolicy_AntiCheat) Descriptor() ([]byte, []int) {
	return file_validation_proto_rawDescGZIP(), []int{0, 2}
}
...
func (*ValidationPolicy_Rules) Descriptor() ([]byte, []int) {
	return file_validation_proto_rawDescGZIP(), []int{0, 3}
}
...
func (*VerificationRecord_ExternalAttestation) Descriptor() ([]byte, []int) {
	return file_validation_proto_rawDescGZIP(), []int{1, 1}
}
...
const file_validation_proto_rawDesc = "" +
	"\n" +
	"\x10validation.proto\x12\tsubnet.v1\"\xa1\b\n" +
	...
	"\x16GetVerificationRecords\x12\x1c.subnet.v1.VerificationQuery\x1a\x1d.subnet.v1.VerificationRecord0\x01B<Z:github.com/PIN-AI/pin-protocol-proto/subnet/proto;subnetv1b\x06proto3"
...
var file_validation_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_validation_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
