...
const file_bid_proto_rawDesc = "" +
	"\n" +
	"\tbid.proto\x12\tsubnet.v1\"\x9f\x03\n" +
	"\x03Bid\x12\x15\n" +
	...
	"\x14BID_STATUS_RUNNER_UP\x10\x05B<Z:github.com/PIN-AI/pin-protocol-proto/subnet/proto;subnetv1b\x06proto3"

var (
	file_bid_proto_rawDescOnce sync.Once
	file_bid_proto_rawDescData []byte
)

func file_bid_proto_rawDescGZIP() []byte {
	file_bid_proto_rawDescOnce.Do(func() {
		file_bid_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_bid_proto_rawDesc), len(file_bid_proto_rawDesc)))
	})
	return file_bid_proto_rawDescData
}

var file_bid_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_bid_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_bid_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bid_proto_rawDesc), len(file_bid_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
