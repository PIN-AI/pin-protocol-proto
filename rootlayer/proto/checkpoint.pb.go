...
func (x *Signature) Reset() {
	*x = Signature{}
	mi := &file_checkpoint_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Signature) Descriptor() ([]byte, []int) {
	return file_checkpoint_proto_rawDescGZIP(), []int{5}
}
...
const file_checkpoint_proto_rawDesc = "" +
	"\n" +
	"\x10checkpoint.proto\x12\frootlayer.v1\"\xb0\x02\n" +
	...
	"\x04slot\x18\x02 \x01(\x04R\x04slot\"\x94\x05\n" +
	...
	"paramsHash\x123\n" +
	"\x05roots\x18\a \x01(\v2\x1d.rootlayer.v1.CommitmentRootsR\x05roots\x12A\n" +
	"\x0eda_commitments\x18\b \x03(\v2\x1a.rootlayer.v1.DACommitmentR\rdaCommitments\x12(\n" +
	"\x10validator_set_id\x18\t \x01(\tR\x0evalidatorSetId\x12\x14\n" +
	"\x05stats\x18\v \x01(\fR\x05stats\x12\x19\n" +
	"\baux_hash\x18\f \x01(\fR\aauxHash\x126\n" +
	"\n" +
	"epoch_slot\x18\r \x01(\v2\x17.rootlayer.v1.EpochSlotR\tepochSlot\x12)\n" +
	...
	"policyRoot\x12B\n" +
	"\n" +
	"signatures\x18\x11 \x01(\v2\".rootlayer.v1.CheckpointSignaturesR\n" +
	"signatures\"\xb4\x01\n" +
	...
	"\tsigner_id\x18\x05 \x01(\tR\bsignerIdBBZ@github.com/PIN-AI/pin-protocol-proto/rootlayer/proto;rootlayerv1b\x06proto3"
...
var file_checkpoint_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_checkpoint_proto_goTypes = []any{
	(*CommitmentRoots)(nil),      // 0: rootlayer.v1.CommitmentRoots
	(*DACommitment)(nil),         // 1: rootlayer.v1.DACommitment
	(*EpochSlot)(nil),            // 2: rootlayer.v1.EpochSlot
	(*CheckpointHeader)(nil),     // 3: rootlayer.v1.CheckpointHeader
	(*CheckpointSignatures)(nil), // 4: rootlayer.v1.CheckpointSignatures
	(*Signature)(nil),            // 5: rootlayer.v1.Signature
}
var file_checkpoint_proto_depIdxs = []int32{
	0, // 0: rootlayer.v1.CheckpointHeader.roots:type_name -> rootlayer.v1.CommitmentRoots
	1, // 1: rootlayer.v1.CheckpointHeader.da_commitments:type_name -> rootlayer.v1.DACommitment
	2, // 2: rootlayer.v1.CheckpointHeader.epoch_slot:type_name -> rootlayer.v1.EpochSlot
	4, // 3: rootlayer.v1.CheckpointHeader.signatures:type_name -> rootlayer.v1.CheckpointSignatures
